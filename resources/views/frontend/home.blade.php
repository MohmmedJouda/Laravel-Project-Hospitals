            ...
            <div class="content">
                <div class="row align-items-center">
                    <div class="col-lg-5 order-lg-0 order-1">
                        <h1 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">الوجهة الأمثل
                            لرعاية أفضل</h1>
                        <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s"> رايت جايد منصة
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="general-card specialist-card wow fadeInUp" data-wow-duration="1s"
                                    ...
                                    <div class="general-card-body">
                                        <h4>{{ $doctor->name }}</h4>
                                        <h6> {{ $doctor->hospital->name ?? 'None' }} </h6>
        ...
        <div class="container">
            <div class="content">
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-4">
                        <h3 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">إحصائيات وأرقام
                        </h3>
                        <h6 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">الأرقام تخبرك
                            عنا بشكل أكبر</h6>
                    </div>
            ...
            <div class="content">
                <div class="owl-carousel rates-slider owl-slider">
                    ...
                    <div class="rates-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                        ...
                        <p>
                            أريد أن أخبركم بأن مستشفيات منصة رايت جايد من أفضل المستشفيات في تركيا لقد تعاملت معها
                            وكان مفيد جدا
                        </p>
                        <div class="rates-card-info">
                            <figure>
                                ...
                                <a href="#">
                                    <div class="offer-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                                        ...
                                        <div class="offer-card-body">
                                            <h4>{{ $offer->title }}</h4>
                                            <h6>{{ $offer->hospital->name ?? 'None' }}</h6>
                                            <div class="price">
                                                <p>{{ $offer->new_price }}</p>
                                                <p>{{ $offer->old_price }}</p>
                                            </div>
        ...
        <section class="standers-section">
            <div class="container">
                <div class="main-title text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                    ...
                    {{-- <h2>{{ $standards->chose_standard ?? 'None' }}</h2> --}}
                </div>
                <div class="content">
                    <div class="row">
                    ...
                    <div class="card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="card-body">
                                ...
                                العلاجية المنتشرة او بالعمليات الفريدة من نوعها والتخصصات النادرة، بحيث يستطيع
                                المريض او الزائر أخذ المعلومات الكاملة والوافية وبدون
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-3">
                        @foreach ($partners as $partner)
                            <div class="partner-card">
                                <figure class="scale">
                                    <img src="{{ Storage::url('partners/' . $partner->cover) }}" class="wow zoomIn"
                                        data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                                </figure>
                            </div>
                        @endforeach
