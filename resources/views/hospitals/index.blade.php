    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('hospitals.create') }}" class="btn btn-success float-right">Add Hospital</a>
                        ...
                        <tbody>
                            @foreach ($item as $key => $hospital)
                                <tr>
                                    ...
                                    <td><span
                                            {{ $hospital->is_active ? 'bg-success' : 'bg-danger' }}>{{ $hospital->is_active ? 'active' : 'non active' }}</span>
                                    </td>
                                    <td><img src="{{ Storage::url('hospitals/' . $hospital->cover) }}" alt="Not Found"
