            ...
            <form method="POST" action="{{ route('offers.store') }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="new_price" class="form-control" id="exampleInputEmail1"
                            placeholder="new price" value="{{ old('new_price') }}">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Enter Old Price</label>
                        <input type="text" name="old_price" class="form-control" id="exampleInputEmail1"
