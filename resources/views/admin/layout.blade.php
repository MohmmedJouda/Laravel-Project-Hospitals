...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('cms/plugins/select2-bootstrap4-theme/select2-bootstrap4.css') }}">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        {{-- @can  هادي الدالة خاصة ب authrlization
                            وتقوم بحجب العناصر
                            واتاحتها للاشخاص الي لديهم الصلاحيات
                        --}}
